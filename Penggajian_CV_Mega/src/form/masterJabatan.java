...
public class masterJabatan extends javax.swing.JFrame {
    ...
    private void simpan() {
        String sql = "insert into jabatan values ('" + id.getText() + "','"
                + nama.getText() + "','" + gaji.getText() + "','"
                + jabatan.getText() + "','" + transportasi.getText() + "')";
        try {
    ...
    private void ubah() {
        String sql = "update jabatan set id_jabatan='" + id.getText() + "', nama='"
                + nama.getText() + "', gapok='" + gaji.getText() + "', jab='"
                + jabatan.getText() + "', transp='" + transportasi.getText()
                + "' where id_jabatan='" + id.getText() + "'";
        try {
            kon.st.executeUpdate(sql);
    ...
    private void hapus() {
        String sql = "delete from jabatan where id_jabatan='" + id.getText() + "'";
        try {
            kon.st.executeUpdate(sql);
    ...
    private void initComponents() {
        ...
        transportasi = new javax.swing.JTextField();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "FORM JABATAN", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(gaji, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(transportasi, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(21, 21, 21)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(jabatan, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void gajiKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_gajiKeyTyped
        ...
        if (!((c >= '0') && (c <= '9') && gaji.getText().length() < 11
    ...
    private void cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariActionPerformed
        ...
        try {
            ...
            if (rss.next()) {
                ...
                String sqli = "select * from jabatan where id_jabatan='" + tcari.getText() + "'";
                ...
                while (rs.next()) {
                    ...
                    nama.setText(kolom2);
                    gaji.setText(kolom3);
                    jabatan.setText(kolom4);
                    transportasi.setText(kolom5);
                }
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if (tambah.getText().equals("TAMBAH")) {
            ...
            if (id.getText().equals("") || nama.getText().equals("") || gaji.getText().equals("")
                    || jabatan.getText().equals("") || transportasi.getText().equals("")) {
    ...
    private void jabatanKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jabatanKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
        if (!((c >= '0') && (c <= '9') && jabatan.getText().length() < 11
                || (c == com.sun.glass.events.KeyEvent.VK_BACKSPACE)
                || (c == com.sun.glass.events.KeyEvent.VK_DELETE))) {
            getToolkit().beep();
            evt.consume();
        }
    }//GEN-LAST:event_jabatanKeyTyped

    private void transportasiKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_transportasiKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
        if (!((c >= '0') && (c <= '9') && transportasi.getText().length() < 11
                || (c == com.sun.glass.events.KeyEvent.VK_BACKSPACE)
                || (c == com.sun.glass.events.KeyEvent.VK_DELETE))) {
            getToolkit().beep();
            evt.consume();
        }
    }//GEN-LAST:event_transportasiKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masterJabatan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new masterJabatan().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField transportasi;
